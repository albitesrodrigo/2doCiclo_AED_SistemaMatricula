...
public class FrmAlumnosMatriculaPendiente extends JFrame implements ActionListener {
	 ...
	 * Create the frame.
	 */
	public FrmAlumnosMatriculaPendiente() {
		setAlwaysOnTop(true);
		setTitle("Reporte | Alumnos con Matricula Pendiente");
